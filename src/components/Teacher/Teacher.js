...
const Teacher = (props) => {
    console.log(props.teacher.social[0])
    const { name, phone, id, email, article, workd,img} = props.teacher;
    return (
        <div className="transition-all duration-500 ease-in-out shadow-xl hover:shadow-2xl p-5 border border-t-8 border-opacity-50 border-green-700 rounded-t-2xl">
